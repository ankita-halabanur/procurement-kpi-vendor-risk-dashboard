...
**Tools:** SQL (MySQL) · Microsoft Excel · Power BI · DAX  
...
End-to-end procurement analytics pipeline to identify vendor risk, track cost savings, and monitor KPIs across 777 purchase orders. Built SQL queries for data extraction, structured the dataset in Excel, and visualised findings in an interactive Power BI dashboard.
